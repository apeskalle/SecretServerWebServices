...
namespace SampleWebServiceConsoleApplication.SSWebService {
    ...
    public interface SSWebServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        SampleWebServiceConsoleApplication.SSWebService.GetSecretResult GetSecret(string token, int secretId);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        SampleWebServiceConsoleApplication.SSWebService.SearchSecretsResult SearchSecrets(string token, string searchTerm);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:thesecretserver.com/GetFavorites", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        SampleWebServiceConsoleApplication.SSWebService.GetFavoritesResult GetFavorites(string token);
    ...
    public partial class SSWebServiceSoapClient : System.ServiceModel.ClientBase<SampleWebServiceConsoleApplication.SSWebService.SSWebServiceSoap>, SampleWebServiceConsoleApplication.SSWebService.SSWebServiceSoap {
        ...
        public SampleWebServiceConsoleApplication.SSWebService.GetSecretResult GetSecret(string token, int secretId) {
        ...
        public SampleWebServiceConsoleApplication.SSWebService.SearchSecretsResult SearchSecrets(string token, string searchTerm) {
            return base.Channel.SearchSecrets(token, searchTerm);
        }
        
        public SampleWebServiceConsoleApplication.SSWebService.GetFavoritesResult GetFavorites(string token) {
